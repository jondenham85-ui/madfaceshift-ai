      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="text-center max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-400 mb-8 max-w-2xl mx-auto">
            Professional-quality face swapping powered by cutting-edge AI. Upload two images and watch the magic happen instantly.
          </p>
        ...
        <div className="mt-20 grid grid-cols-1 md:grid-cols-3 gap-8">
          {[
            { title: "Lightning Fast", desc: "Get results in under 30 seconds with our optimized AI pipeline." },
            { title: "Studio Quality", desc: "Photorealistic results that look natural and professional." },
            { title: "Secure & Private", desc: "Your images are processed and deleted. We never store your photos." },
          ].map((f, i) => (
